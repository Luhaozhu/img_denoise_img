...
class Network(nn.Module):
    ...
    def __init__(self, n_feat=32):
        ...
        self.enc3 = EncoderStage(in_channels=128, out_channels=256, num_blocks=3)
        ...
        self.dec2 = DecoderStage(in_channels=64, skip_in_channels=64, out_channels=16)
...
if __name__ == "__main__":
    ...
    tensor = (torch.rand(1, 2, 1024, 1280),)
    # 分析FLOPs
